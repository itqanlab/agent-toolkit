...
- Installed as a Claude Code plugin, the slash command is now `/hetzner-ops:hetzner-ops`, with the plugin name in front. Asking in words works as before, and a copy in a skills folder keeps the plain name `/hetzner-ops`.
